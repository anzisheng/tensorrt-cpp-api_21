...
public:
        ...
        , mBatchSize(batchSize)
    {
        ...
        std::cout <<"input and out bindings:"<< mEngine->getNbBindings()<<std::endl;
        if(context) std::cout << "hello"<<std::endl; else  std::cout <<"world"<<std::endl;
        for (int i = 0; i < mEngine->getNbBindings(); i++)
        {
            //std::cout <<"bindings dims:"<< context->getBindingDimensions(i)<<std::endl;            
            auto dims = context ? context->getBindingDimensions(i) : mEngine->getBindingDimensions(i);
            if(context == nullptr)
            {
                std::cout <<"mEngine->getBindingDimensions: "<< i << " " << dims.d[0] << " "<<dims.d[1] <<" "<<dims.d[2] <<" "<<dims.d[3] <<std::endl;  
            }
            ...
            std::cout <<i <<"所有维度乘积vol:"<< vol<<std::endl;
        ...
        std::cout << "mDeviceBindings size: " <<mDeviceBindings.size() <<std::endl;
        std::cout << "mManagedBuffers size: " <<mManagedBuffers.size() <<std::endl;
    }
...
private:
    ...
    {
        //cout << "mEngine->getNbBindings(): " <<mEngine->getNbBindings()<<endl;
        for (int i = 0; i < mEngine->getNbBindings(); i++)
        {
            void* dstPtr
