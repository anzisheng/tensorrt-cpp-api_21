# ifndef FACERECOGNIZER2
# define FACERECOGNIZER2
#include <fstream>
#include <sstream>
#include "yolov8.h"
...
class FaceEmbdding_trt2
{
public:
	FaceEmbdding_trt2(std::string modelpath, const YoloV8Config &config);
...
private:
	std::unique_ptr<Engine<float>> m_trtEngine_embedding2 = nullptr;
